...
import com.lanhi.vgo.databinding.ActivityLaguageChangeBinding;
import com.lanhi.vgo.mvvm.view.MainActivity;
import com.lanhi.vgo.mvvm.view.user.LoginActivity;
...
public class LanguageChangeActivity extends BaseActivity {
    ActivityLaguageChangeBinding binding;
    private int currentSelect;
    private boolean isShowBtnBack = false;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = DataBindingUtil.setContentView(this,R.layout.activity_laguage_change);
